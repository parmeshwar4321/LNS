...
export default function Navbar({network}) {
      ...
      <div className="max-w-10xl bg-black mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center  py-1 md:justify-start md:space-x-10">
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a
            href="/projects"
            className="whitespace-nowrap pr-10 text-base font-medium text-white hover:text-red-900 font-bold"
            >
Projects            </a>
            <a
              href="/community"
...
Community            </a>
            ...
            <div className="flex items-center justify-between whitespace-nowrap pr-10 text-base font-medium text-white font-bold">
            <div className="m-2">
            <img
            alt="Network logo"
            className="object-contain h-5 w-8"
            src={polygonLogo?.src}
          />
          </div>
            ...
            <div className="pt-5 pb-6 px-5">
              ...
              <div className="mt-6">
                <nav className="grid gap-y-8">
                  <a
                    href="/projects"
                    className="whitespace-nowrap pr-10 text-base font-medium text-gray-500 hover:text-red-900"
                  >
                  Projects                  </a>
                  <a
                    href="#"
